package io.anyway.bigbang.framework.executor.config;

import io.anyway.bigbang.framework.executor.TransmittableExecutorMetricCollector;
import io.anyway.bigbang.framework.executor.TransmittableTaskExecutor;
...
@Configuration
public class ExecutionConfigure {
